        ...
        <div className="editorBody">
            <div className="editorContainer">
                <div className="editImg">
                    <div className="editPersInfo_avatar" style={{ backgroundImage: `url(${info.imgs[0]})` }} />
                    ...
                    <div className="editPersInfo_avatar border_avatar" style={{ backgroundImage: `url(${imgSrc})` }} />
                </div>
